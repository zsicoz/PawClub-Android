...
public class MainPage_Shelter extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mainpage_shelter);
        ...
        getFragmentManager().beginTransaction().replace(R.id.MainPageFrame,new ShelterDonateFragment()).commit();
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.shelter_nav_home:
                getFragmentManager().beginTransaction().replace(R.id.MainPageFrame,
                        new ShelterDonateFragment()).commit();
                break;
            case R.id.shelter_nav_settings:
                Toast.makeText(this, "Ayarlar'a basıldı", Toast.LENGTH_SHORT).show();
                break;
            case R.id.shelter_nav_exit:
                Toast.makeText(this, "Çıkış Yapıldı", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(MainPage_Shelter.this,MainActivity.class);
