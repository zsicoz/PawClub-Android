...
public class MainPage_Admin extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.admin_nav_profile:
                ...
                break;
            case R.id.admin_nav_donate:
                getFragmentManager().beginTransaction().replace(R.id.MainPageFrame,
                        new AdminDonateCheck()).commit();
                break;
